...
<div id="wrapper">
		...
		<br>
		<article>School of Music administration is intended for school administration tasks. 
		It enables the administrator to easily add, update and delete courses, teachers and students. 
		<br><br>
